...
// ************ FIX: تفعيل مكتبة CORS لحل مشكلة الاتصال ************
app.use(cors());

// Middleware لمعالجة JSON
app.use(express.json());

// FIX: هذا يسمح لـ Express بتقديم الملفات الثابتة من مجلد public
